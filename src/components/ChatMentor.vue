...
onMounted(() => {
  if (courseStore.teacherChatHistory.length === 0) {
    ...
    courseStore.teacherChatHistory.push({
      role: 'assistant',
      content: '¡Hola! Soy tu **Mentor IA (Gemini 3 Flash)**. Estoy aquí para ayudarte a diseñar clases innovadoras, resolver dudas pedagógicas o darte ideas creativas para tu aula. ¿En qué puedo apoyarte hoy?',
      timestamp: new Date()
    })
  }
})
          ...
          <div class="flex items-center gap-5">
            ...
            <div>
              ...
              <div class="flex items-center gap-2">
                ...
                <p class="text-[10px] font-black uppercase tracking-[0.2em] text-primary/80">Gemini 3 Flash • Online</p>
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div v-if="courseStore.isAskingTutor" class="flex flex-col items-start animate-fade-in">
          <div class="bg-white/5 border border-white/10 p-6 rounded-[2.5rem] rounded-bl-none flex items-center gap-4">
            ...
            <span class="text-[10px] font-black text-primary uppercase tracking-[0.2em] animate-pulse">Procesando con Gemini 3 Flash...</span>
          </div>
        </div>
      </div>
